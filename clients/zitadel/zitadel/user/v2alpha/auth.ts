...
export const SendPasskeyRegistrationLink = {
  ...
  create<I extends Exact<DeepPartial<SendPasskeyRegistrationLink>, I>>(base?: I): SendPasskeyRegistrationLink {
    return SendPasskeyRegistrationLink.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SendPasskeyRegistrationLink>, I>>(object: I): SendPasskeyRegistrationLink {
    const message = createBaseSendPasskeyRegistrationLink();
...
export const ReturnPasskeyRegistrationCode = {
  ...
  create<I extends Exact<DeepPartial<ReturnPasskeyRegistrationCode>, I>>(base?: I): ReturnPasskeyRegistrationCode {
    return ReturnPasskeyRegistrationCode.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ReturnPasskeyRegistrationCode>, I>>(_: I): ReturnPasskeyRegistrationCode {
    const message = createBaseReturnPasskeyRegistrationCode();
    return message;
  },
};
...
export const PasskeyRegistrationCode = {
  ...
  create<I extends Exact<DeepPartial<PasskeyRegistrationCode>, I>>(base?: I): PasskeyRegistrationCode {
    return PasskeyRegistrationCode.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<PasskeyRegistrationCode>, I>>(object: I): PasskeyRegistrationCode {
    const message = createBasePasskeyRegistrationCode();

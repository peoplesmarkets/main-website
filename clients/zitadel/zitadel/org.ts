...
export const OrgQuery = {
  ...
  create<I extends Exact<DeepPartial<OrgQuery>, I>>(base?: I): OrgQuery {
    return OrgQuery.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OrgQuery>, I>>(object: I): OrgQuery {
    const message = createBaseOrgQuery();
...
export const OrgNameQuery = {
  ...
  create<I extends Exact<DeepPartial<OrgNameQuery>, I>>(base?: I): OrgNameQuery {
    return OrgNameQuery.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OrgNameQuery>, I>>(object: I): OrgNameQuery {
    const message = createBaseOrgNameQuery();
    message.name = object.name ?? "";
...
export const OrgDomainQuery = {
  ...
  create<I extends Exact<DeepPartial<OrgDomainQuery>, I>>(base?: I): OrgDomainQuery {
    return OrgDomainQuery.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OrgDomainQuery>, I>>(object: I): OrgDomainQuery {
    const message = createBaseOrgDomainQuery();
...
export const OrgStateQuery = {
  ...
  create<I extends Exact<DeepPartial<OrgStateQuery>, I>>(base?: I): OrgStateQuery {
    return OrgStateQuery.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OrgStateQuery>, I>>(object: I): OrgStateQuery {
    const message = createBaseOrgStateQuery();
    message.state = object.state ?? 0;
    return message;
  },
...
export const DomainSearchQuery = {
  ...
  create<I extends Exact<DeepPartial<DomainSearchQuery>, I>>(base?: I): DomainSearchQuery {
    return DomainSearchQuery.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DomainSearchQuery>, I>>(object: I): DomainSearchQuery {
    const message = createBaseDomainSearchQuery();
...
export const DomainNameQuery = {
  ...
  create<I extends Exact<DeepPartial<DomainNameQuery>, I>>(base?: I): DomainNameQuery {
    return DomainNameQuery.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DomainNameQuery>, I>>(object: I): DomainNameQuery {
    const message = createBaseDomainNameQuery();
    message.name = object.name ?? "";
    message.method = object.method ?? 0;
    return message;

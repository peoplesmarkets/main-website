...
export const AuthOption = {
  ...
  create<I extends Exact<DeepPartial<AuthOption>, I>>(base?: I): AuthOption {
    return AuthOption.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AuthOption>, I>>(object: I): AuthOption {
    const message = createBaseAuthOption();
...
export const CustomHTTPResponse = {
  ...
  create<I extends Exact<DeepPartial<CustomHTTPResponse>, I>>(base?: I): CustomHTTPResponse {
    return CustomHTTPResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CustomHTTPResponse>, I>>(object: I): CustomHTTPResponse {
    const message = createBaseCustomHTTPResponse();

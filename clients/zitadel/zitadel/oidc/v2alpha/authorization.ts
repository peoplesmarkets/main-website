...
export const AuthorizationError = {
  ...
  create<I extends Exact<DeepPartial<AuthorizationError>, I>>(base?: I): AuthorizationError {
    return AuthorizationError.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AuthorizationError>, I>>(object: I): AuthorizationError {
    const message = createBaseAuthorizationError();

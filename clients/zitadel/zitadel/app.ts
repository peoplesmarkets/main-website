...
export const AppNameQuery = {
  ...
  create<I extends Exact<DeepPartial<AppNameQuery>, I>>(base?: I): AppNameQuery {
    return AppNameQuery.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AppNameQuery>, I>>(object: I): AppNameQuery {
    const message = createBaseAppNameQuery();
    message.name = object.name ?? "";

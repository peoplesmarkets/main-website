...
export const LockoutSettings = {
  ...
  create<I extends Exact<DeepPartial<LockoutSettings>, I>>(base?: I): LockoutSettings {
    return LockoutSettings.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<LockoutSettings>, I>>(object: I): LockoutSettings {
    const message = createBaseLockoutSettings();

...
export const UserIDQuery = {
  ...
  create<I extends Exact<DeepPartial<UserIDQuery>, I>>(base?: I): UserIDQuery {
    return UserIDQuery.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<UserIDQuery>, I>>(object: I): UserIDQuery {
    const message = createBaseUserIDQuery();
    message.userId = object.userId ?? "";
    return message;
  },
